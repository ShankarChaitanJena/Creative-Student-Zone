    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sub1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDialog(getActivity(),Demoppt.class, Demonotes.class, DemoAssignment.class, "Organizational Behaviour");
            }
        });
        ...
        sub2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showDialog(getActivity(),Demoppt.class, Demonotes.class, DemoAssignment.class, "Financial And Market Institution");
            }
        });
        ...
        sub3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showDialog(getActivity(),Demoppt.class, Demonotes.class, DemoAssignment.class, "Advertisement And Sales Promotion");
            }
        });
        ...
        sub4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showDialog(getActivity(),Demoppt.class, Demonotes.class, DemoAssignment.class, "Management Information System And DSS");
            }
        });
        ...
        sub5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showDialog(getActivity(),Demoppt.class, Demonotes.class, DemoAssignment.class, "Indian Socity And Culture");            }
        });
