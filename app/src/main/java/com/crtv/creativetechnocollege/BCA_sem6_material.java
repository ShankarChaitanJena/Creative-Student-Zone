...
public class BCA_sem6_material extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b_c_a_sem6_material, container, false);

        sub1=view.findViewById(R.id.bcadatascience);
        sub2=view.findViewById(R.id.bcagraphic);
        sub3=view.findViewById(R.id.bcanumeric);
        ...
        sub3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showDialog(getActivity(), Demoppt.class, Demonotes.class, DemoAssignment.class, "Numerical Technique");
            }
        });
        return  view;
    }
